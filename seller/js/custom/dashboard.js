jQuery(document).ready(function(){
		...
		jQuery('#phone').click(function(){
			jQuery('.centercontent iframe').attr("src","phone.html");
		});
		jQuery('#bed').click(function(){
			jQuery('.centercontent iframe').attr("src","bed.html");
		});
		jQuery('#firstPage').click(function(){
			jQuery('.centercontent iframe').attr("src","first.html");
		});
		jQuery('#phoneorder').click(function() {
			jQuery('.centercontent iframe').attr("src","phoneorder.html");
		})
		...
		jQuery("#productManagementBtn").click(function(){
			...
			jQuery("#orderManagement").hide();
		})
		jQuery("#orderManagementBtn").click(function(){
			jQuery("#orderManagement").show();
			jQuery("#productManagement").hide();
		})
